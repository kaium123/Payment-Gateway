...
Endpoints: 
    ...
    1. Process a Payment using Shift4: 
        ...
        Response:
            ...
            {
                "transactionID": "char_3Cqru83pWsPDS7xao1D0GLXX",
                "amount": 100.5,
                "currency": "USD",
                "card": {
                    "bin": "411111"
    ...
    2. Process a Payment using ACI:
        ...
        {
            "transactionID": "8ac7a4a090a77b8b0190a84138867f7e",
            "amount": 92,
            "currency": "EUR",
            "card": {
                "bin": "420000"
            },
            "created": "2024-07-12 18:42:45.099+0000"
        }

    3. Retrieve Payment Status by ID
        Endpoint: GET http://localhost:3000/api/payments/8ac7a4a090a77b8b0190a84138867f7e
...
Command-Line Interface (CLI): 
    ...
    Reponse:
        ...
        {
            transactionID: '8ac7a4a290a77bcf0190a841c4f208f4',
            amount: 100,
            currency: 'USD',
            card: { bin: '411111' },
            created: '2024-07-12 18:43:20.949+0000'
        }
    ...
    Response: 
        ...
        {
            transactionID: '8ac7a4a190a7734a0190a843f8c23d07',
            amount: 100,
            currency: 'USD',
            card: { bin: '411111' },
            created: '2024-07-12 18:45:45.285+0000'
        }
